...
| w/o image（目標） | abl_no_image | 0.9401 | 0.4700 | 0.8292 | 8.8163 | 0.6301 | 0.5071 |
...
| w/o image（目標） | 0.9307 | 0.4830 | 0.8293 | 8.6352 | 0.6511 | 0.5168 |
...
| w/o image（目標） | 0.9799 | 0.4532 | 0.8318 | 8.4562 | 0.6660 | 0.5194 |
...
| w/o image（目標） | 0.980 ± 0.063 | 0.454 ± 0.033 | 0.828 ± 0.003 | 8.655 ± 0.661 | 0.645 ± 0.047 | 0.511 ± 0.010 |
...
| w/o image（目標） | 0.952 ± 0.019 | 0.467 ± 0.012 | 0.832 ± 0.002 | 8.305 ± 0.122 | 0.670 ± 0.009 | 0.515 ± 0.007 |
...
> 2. **組件排序兩版一致**：full / w/o image（目標） / meta only 三者相近且最佳，RAG off 次之，text-only / image-only 最弱 → **消融的方向性結論不受 trend 開關影響**。
...
> 3. **image 對 meanScore 尤其關鍵**：w/o image（目標），score 7.5911→8.6352（大幅退步）、pop 0.8823→0.9307。
